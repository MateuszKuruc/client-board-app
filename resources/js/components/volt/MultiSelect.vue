...
const theme = ref<MultiSelectPassThroughOptions>({
    ...
    label: `flex items-center gap-1 flex-wrap overflow-hidden text-ellipsis px-3 py-2 p-has-chip:py-1 p-has-chip:px-[0.375rem]
    ...
    pcFilter: {
        root: `w-full appearance-none rounded-md outline-hidden
            ...
            transition-colors duration-200 shadow-[0_1px_2px_0_rgba(18,18,23,0.05)] h-[2.5rem]`
    },
